...
Follow these steps to stage and verify the mobile environment:
...
unsafely-treat-insecure-origin-as-secure
```
and switch to Enabled, append your exact host LAN address context (http://192.168.100.xx:5173), and relaunch the software browser.
